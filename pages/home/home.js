...
avatarUrl:"https://lg-6enwjric-1256925828.cos.ap-shanghai.myqcloud.com/home/avatar_default.jpg",
  ...
  onClickSelf:function(){
    wx.navigateTo({
      url: '../challenge/challenge?id=24&frompageid=1',
    })
  },
  ...
  onClickPK: function() {
    ...
    if(isGoShipping) {
      ...
      wx.navigateTo({
        url: '../invitation/invitation?id=24&frompageid=2',
      })
    }
  ...
  onClickStudy:function() {
    wx.navigateTo({
      url: '../study/study?id=24&frompageid=4',
    })
  },

  onClickMore:function() {
    wx.navigateTo({
      url: '../minipstore/minipstore?id=24',
    })
  },
  ...
  onShareAppMessage: function (res) {
    let that = this
    return {
      title: '[有人@我]在准备科目一？来试试超级好用的科目一模拟考试吧！',
